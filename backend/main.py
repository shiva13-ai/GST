...
NEO4J_PASSWORD  = os.getenv("NEO4J_PASSWORD",  "x-xxxxxxxxxxxxxxxxxxxxxxxssssssx")
GEMINI_KEY      = os.getenv("GEMINI_API_KEY", "xxxxxxxxxxxxxxxxxxxxxxxxxxxx")      # optional — falls back to rule-based
